...
static const char *ABOUT_TEXT =
  ...
  "FUEL IS SPEED\n"
  "The tank holds delta-v, and you pay to speed up AND to brake. On the "
  "contract card, UP/DOWN picks your cruise plan - AUTO, a fixed speed, or "
  "MAX - and each one shows its fuel and both clocks before you commit. "
  "Bigger fill-ups get a bulk discount.\n\n"
  "THE G-RATING\n"
  "Every load caps how hard the autopilot may burn and brake, and your drive "
  "caps it again - the card shows the BURN you get. Fragile freight means "
  "gentle ramps, and gentle ramps cost years on both clocks. Inertial Dampers "
  "raise what the load will take; Redline Coils raise what the drive can "
  "give, which is what puts redline speeds within reach of a short leg.\n\n"
  "THE LONG GAME\n"
  ...
  "credits and years. A leg's top gamma is capped by its length, so redline - "
  "gamma 2,000 on a clean run - takes Redline Coils, rugged freight, and a "
  "long leg flown at WARP. Clear it and deep space opens: thousand-lightyear "
  "stations where those coils finally have room to run.\n\n"
  "Retire rich, not old.";
